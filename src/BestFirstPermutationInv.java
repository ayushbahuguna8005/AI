...
class BestFirstPermutationInv extends BestFirstSearch {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		List<State> solutionPath = BestFirstPermutationInversion(root);
		...
		printSolution(solutionPath, "puzzleBFS-h6-Experiment.txt");
